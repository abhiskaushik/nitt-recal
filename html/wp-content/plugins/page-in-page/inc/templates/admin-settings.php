...
<form action="" method="post" id="twl-pip-settings">
	...
	<table class="twl-social-settings">
		...
		<tr>
			<td>Use <a href="http://isotope.metafizzy.co/" target="_blank">Jquery Isotope?</a></td>
			<td>
				<label><input type="radio" name="facebook[use_jquery.isotope]" value="1" <?php twl_pip_set('use_jquery.isotope', $settings['facebook'], 'radio', 1) ?>> Yes </label>
				<label><input type="radio" name="facebook[use_jquery.isotope]" value="0" <?php twl_pip_set('use_jquery.isotope', $settings['facebook'], 'radio', 0) ?>> No </label>
				<i>Your feeds will be listed using this jQuery plugin (in a masonry like manner)</i>
			</td>
		</tr>
		<tr>
	...
	<table class="twl-social-settings">
		...
		<tr>
			<td>Use <a href="http://isotope.metafizzy.co/" target="_blank">Jquery Isotope?</a></td>
			<td>
				<label><input type="radio" name="twitter[use_jquery.isotope]" value="1" <?php twl_pip_set('use_jquery.isotope', $settings['twitter'], 'radio', 1) ?>> Yes </label>
				<label><input type="radio" name="twitter[use_jquery.isotope]" value="0" <?php twl_pip_set('use_jquery.isotope', $settings['twitter'], 'radio', 0) ?>> No </label>
				<i>Your feeds will be listed using this jQuery plugin (in a masonry like manner)</i>
			</td>
		</tr>
		<tr>
