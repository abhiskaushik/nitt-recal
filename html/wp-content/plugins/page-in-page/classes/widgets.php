...
class TWL_Page_IN_Page_Widget extends WP_Widget {
	...
	/*private $title_template_id;
	private $title_template_name;

	private $desc_template_id;
	private $desc_template_name;*/
	...
	public function widget($args, $instance) {
 	...
 	public function form($instance) {
		...
		/* = !empty($instance['title_template'])  ? $instance['title_template']  : '';
		$content_template = !empty($instance['content_template'])  ? $instance['content_template']  : '';*/
		...
		<!--
		<p>
			<label for="<?php echo $this->title_template_id; ?>"><?php _e('Title Template: ', TWL_PIP_TEXT_DOMAIN); ?></label>
			<textarea class="widefat" id="<?php echo $this->title_template_id; ?>" name="<?php echo $this->title_template_name; ?>"><?php echo esc_attr($title_template); ?></textarea>
		</p>
		<p>
			<label for="<?php echo $this->desc_template_id; ?>"><?php _e('Content Template: ', TWL_PIP_TEXT_DOMAIN); ?></label>
			<textarea class="widefat" id="<?php echo $this->desc_template_id; ?>" name="<?php echo $this->desc_template_name; ?>"><?php echo esc_attr($content_template); ?></textarea>
		</p>
		-->
		<p>
	...
	public function update($new_instance, $old_instance) {
		...
		/*$instance['title_template'] = $new_instance['title_template'];
		$instance['content_template'] = $new_instance['content_template'];*/
	...
	private function field_names() {
		...
		/*$this->title_template_id = $this->get_field_id('title_template');
		$this->title_template_name = $this->get_field_name('title_template');

		$this->desc_template_id = $this->get_field_id('content_template');
		$this->desc_template_name = $this->get_field_name('content_template');*/
