...
class TWL_Page_In_Page_Admin extends TWL_Page_In_Page {
	...
	private function settingsSave() {
		...
		$settable = array(
			'facebook' => array('page_id', 'app_id', 'app_secret', 'use_jquery.isotope', 'alert_sdk_errors'),
			'twitter' => array('screen_name', 'customer_key', 'customer_secret', 'access_token', 'access_token_secret', 'use_jquery.isotope', 'alert_sdk_errors'),
		);
