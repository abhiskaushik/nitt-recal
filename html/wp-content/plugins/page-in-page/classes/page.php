...
class TWL_Page_IN_Page_Page extends TWL_Page_In_Page {
	...
	private function template() {
		...
		if (!empty($this->args['show_page_title'])) {
			$_title_template = '<span class="twl-page-in-page-title">${page_title}</span>';
		}
		...
		if (!empty($this->args['show_featured_image'])) {
			$_image_template = '<div class="twl-page-in-page-image"><img src="${page_image}" /></div>';
		}
	...
	public static function shortcode_facebook($params) {
		...
		try {
			...
			$page_vars['use_jquery_isotope'] = $facebook_config['use_jquery.isotope'];
	...
	public static function shortcode_twitter() {
		...
		try {
			...
			$page_vars['use_jquery_isotope'] = $twitter_config['use_jquery.isotope'];
